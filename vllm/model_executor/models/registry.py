...
_TEXT_GENERATION_MODELS = {
    ...
    "DeepForCausalLM": ("pacific_prime", "DeepForCausalLM"),  # Pacific-Prime (INL/Complexity)
    "ComplexityForCausalLM": ("pacific_prime", "ComplexityForCausalLM"),  # Pacific-Prime (alias)
